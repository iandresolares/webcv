...
from .pages import about, imprint, index, privacy, projects, contact
...
style = {
    ...
    # "background": "linear-gradient(45deg, #8A6FDF, #FFDB15)",  # noqa: F601
...
app.add_page(component=contact, route="/contact", title=" Andrés Solares | Contact")
